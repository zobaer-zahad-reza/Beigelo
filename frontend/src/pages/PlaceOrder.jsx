...
const PlaceOrder = () => {
  ...
  const delivery_fee =
    formData.city === "" ? 0 : formData.city === "Dhaka" ? 80 : 120;
  ...
  const onSubmitHandler = async (event) => {
    ...
    `,
        ...
        case "bkash": {
          const responseBkash = await axios.post(
            ...
            {isBuyNowMode && buyNowItem ? (
              <div className="py-4 border-t border-b text-gray-700 flex items-center gap-4">
                ...
                <div className="flex-1">
                  <p className="text-lg font-bold">{buyNowItem.name}</p>
              ...
              cartItemsList.map((item, index) => (
                ...
                >
                  ...
                  />
                  <div className="flex-1">
                    <p className="text-lg font-bold">{item.productData.name}</p>
                    <div className="flex items-center gap-5 mt-2 text-sm">
                      <p>
                        {currency}
